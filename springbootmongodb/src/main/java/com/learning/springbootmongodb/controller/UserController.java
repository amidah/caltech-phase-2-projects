...
public class UserController {
	...
	public ResponseEntity<Response> addUser(@RequestParam String name, @RequestParam String phone,
		...
		try {
			...
			Response response = new Response(101, "User " + name + " saved successfully at " + new Date(), null);
			return new ResponseEntity<Response>(response, HttpStatus.CREATED);
		} catch (Exception e) {
			Response response = new Response(301, "OOPS!! Something Went Wrong " + e.getMessage(), null);
